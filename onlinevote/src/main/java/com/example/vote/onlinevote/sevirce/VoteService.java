...
public class VoteService {
    ...
    public VoteResponseDTO castVote(VoteRequestDTO voteRequest, String voterEmail) {
        // Validate voter credentials first
        UserCredentials credentials = credentialsRepository.findByEmail(voterEmail)
            .orElseThrow(() -> new UnauthorizedException("Invalid voter credentials"));
        
        if (!credentials.isFirstLogin()) {
            throw new UnauthorizedException("Please complete your first login before voting");
        }
